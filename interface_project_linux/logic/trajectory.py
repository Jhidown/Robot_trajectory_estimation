...
class TrajectoryPlotter:
    ...
    def update(self,vo_trajectory,ekf_trajectory,encoder_trajectory,mode="VO+EKF"):
        show_vo = "VO" in mode
        show_ekf = "EKF" in mode
        show_encoder = "Encoders" in mode


        if show_vo and len(vo_trajectory) > 0:
        ...
        if show_ekf and len(ekf_trajectory) > 0:
        ...
        if show_encoder and len(encoder_trajectory) > 0:
